...
points(gaussian,pch=16,cex=0.4,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="dark grey")
points(gaussian1,pch=16,cex=0.4)
...
points(gaussian,pch=16,cex=0.4,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="dark grey")
points(gaussian2,pch=16,cex=0.4)
...
points(gaussian,pch=16,cex=0.4,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="dark grey")
points(gaussian3,pch=16,cex=0.4)
...
points(gaussian,pch=16,cex=0.4,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="dark grey")
points(gaussian4,pch=16,cex=0.4)
