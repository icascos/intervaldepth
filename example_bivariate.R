...
points(gaussian,pch=16,cex=0.56,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="honeydew4")
points(gaussian1,pch=16,cex=0.56)
...
points(gaussian,pch=16,cex=0.56,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="honeydew4")
points(gaussian2,pch=16,cex=0.56)
...
points(gaussian,pch=16,cex=0.56,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="honeydew4")
points(gaussian3,pch=16,cex=0.56)
...
points(gaussian,pch=16,cex=0.56,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="honeydew4")
points(gaussian4,pch=16,cex=0.56)
