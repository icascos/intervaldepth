...
points(gaussian,pch=16,cex=0.5,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="grey10")
points(gaussian1,pch=16,cex=0.5)
...
points(gaussian,pch=16,cex=0.5,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="grey10")
points(gaussian2,pch=16,cex=0.5)
...
points(gaussian,pch=16,cex=0.5,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="grey10")
points(gaussian3,pch=16,cex=0.5)
...
points(gaussian,pch=16,cex=0.5,col="honeydew4")
lines(zonoidreg(gaussian),lwd=2,col="grey10")
points(gaussian4,pch=16,cex=0.5)
